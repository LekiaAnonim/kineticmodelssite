...
C#CO
Imported from CombFlame2014/657-Jin/thermo.txt.""",
    longDesc = 
"""
Formula: C2H2O
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[1.56854,0.0346523,6.81681e-06,-2.79951e-08,1.23077e-11,-17130,17.908], Tmin=(300,'K'), Tmax=(1000,'K')),
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[0.961676,0.0257359,1.5609e-05,-2.66565e-08,8.9418e-12,4656.44,24.8054], Tmin=(300,'K'), Tmax=(1000,'K')),
