...
longDesc = """
Thermo entries from model CombFlame2014/405-Cai
...
C#CO
_imported from CombFlame2014/405-Cai/thermo.txt.""",
    longDesc = 
"""
Formula: C2H2O
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[3.12528,0.00977822,4.52145e-06,-9.00946e-09,3.19372e-12,-4108.51,11.2288], Tmin=(298,'K'), Tmax=(1000,'K')),
