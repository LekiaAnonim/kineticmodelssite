...
longDesc = """
Thermo entries from model PCI2019/789-Lapointe1
...
C=C
_imported from PCI2019/789-Lapointe1/reduced_NC7_therm.txt.""",
    longDesc = 
"""
Formula: C2H4
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[1.67447,0.0564608,-4.25139e-05,1.76743e-08,-3.0928e-12,-15047.1,18.229], Tmin=(298,'K'), Tmax=(1000,'K')),
            NASAPolynomial(coeffs=[8.51209,0.0334672,-1.39467e-05,2.1703e-09,0,-16652.9,-15.8988], Tmin=(1000,'K'), Tmax=(4000,'K')),
        ],
        Tmin = (298,'K'),
        Tmax = (4000,'K'),
    ),
...
"""
Formula: C4H9O2
Species name in model: TXC4H9O2
_auto-generated from kinetic-models database.
""",
)
