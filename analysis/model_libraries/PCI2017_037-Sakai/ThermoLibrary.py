...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[1.65982,0.0174427,-1.3563e-05,5.53066e-09,-9.24027e-13,-6958.5,14.9169], Tmin=(298,'K'), Tmax=(1391,'K')),
            NASAPolynomial(coeffs=[6.60179,0.00523169,-1.79376e-06,2.82184e-10,-1.6561e-14,-8610.86,-11.3932], Tmin=(1391,'K'), Tmax=(5000,'K')),
        ],
        Tmin = (298,'K'),
        Tmax = (5000,'K'),
    ),
...
C=C=O
Imported from PCI2017/037-Sakai/thermo.txt.""",
    longDesc = 
"""
Formula: C2H2O
...
Burke et al., Combust. Flame 162 (2015) 296-314
Burke et al., Combust. Flame 161 (2014) 2765-2784.
[H]
Imported from PCI2017/037-Sakai/thermo.txt.""",
    longDesc = 
"""
